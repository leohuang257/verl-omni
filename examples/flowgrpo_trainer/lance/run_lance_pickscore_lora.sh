# Lance LoRA RL, vllm_omni rollout (FlowGRPO) with PickScore reward
#
...
#
# The model path must point at the bundled Lance repo root (containing
# Lance_3B/, Qwen2.5-VL-ViT/ and Wan2.2_VAE.pth).
set -x
...
model_name=${LANCE_MODEL_PATH:-~/models/Lance}
...
python3 -m verl_omni.trainer.main_diffusion \
    ...
    actor_rollout_ref.model.tokenizer_path=$model_name/Lance_3B \
